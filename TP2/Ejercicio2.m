...
fs = 2.5*200e6;               % Sampling frequency [Hz]
Ts = 1/fs;              % Sampling time [s]

OVR = 10;                % Oversampling factor (fs_ch/fs)
...
X_c_v = fftshift(abs(fft(tone_cont, NFFT*OVR))/(n_samples*OVR));
